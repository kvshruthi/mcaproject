                    ...
                    <section className="main-section contact" id="contact">
                        <div className="contact_section">
                            ...
                            <a className="group" href="/">
                                <center>  <img src={group} alt="" height="150px" width="150px" className="rollIn animated wow animated" ></img>
                                {/* Farm
            <span className="color-b">Easy</span> */}
                                 
                                <h4>NEWSPORT  is the  Positive News Application Portal Using Sentiment Analysis & MERN Stack. This project gives you the positive, negative and neutral news, that is the system which filters or selects the news  based on Sentiment Analysis. 
                                    </h4> </center>
